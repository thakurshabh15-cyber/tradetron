...
Single source of truth for all feature-access decisions:
  ...
  - PRO       : multi-broker, algos, copy trading                (₹1,499/mo)
  - CREATOR   : marketplace publishing + payout eligibility      (₹4,999/mo)
  - INSTITUTIONAL : Enterprise B2B — unlimited everything        (₹4,999/mo)
...
PLAN_LIMITS: dict[str, dict[str, Any]] = {
    ...
    "PRO": {
        "display_name": "Pro",
        "price_monthly": 1499,
        "price_yearly": 14390,  # ~20% discount
        "max_brokers": 3,
        "max_algos": 5,
