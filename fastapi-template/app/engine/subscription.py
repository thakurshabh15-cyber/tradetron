...
Single source of truth for all feature-access decisions:
  - FREE      : 1 broker, 1 algo, no copy trading                (Free)
  - PRO       : multi-broker, algos, copy trading                (₹7,999/mo)
  - CREATOR   : marketplace publishing + payout eligibility      (₹14,999/mo)
  - INSTITUTIONAL : Enterprise B2B — unlimited everything        (₹24,999/mo)

Marketplace economics: creators keep CREATOR_REVENUE_SHARE of net
subscription revenue generated by their published strategies (80/20).
...
# Verified-strategy creators retain 80% of net revenue; platform treasury 20%.
CREATOR_REVENUE_SHARE: float = 0.80
PLATFORM_REVENUE_SHARE: float = round(1.0 - CREATOR_REVENUE_SHARE, 2)
...
PLAN_LIMITS: dict[str, dict[str, Any]] = {
    ...
    "PRO": {
        "display_name": "Pro",
        "price_monthly": 7999,
        "price_yearly": 76790,  # ~20% discount
        "max_brokers": 3,
        "max_algos": 5,
    ...
    "CREATOR": {
        ...
        "price_monthly": 14999,
        "price_yearly": 143990,  # ~20% discount
        "max_brokers": 10,
        "max_algos": 25,
        "copy_trading_allowed": True,
        "tick_speed": "50ms",
    ...
    "INSTITUTIONAL": {
        ...
        "price_monthly": 24999,
        "price_yearly": 239990,  # ~20% discount
        "max_brokers": 99,
        "max_algos": 99,
        "copy_trading_allowed": True,
        "tick_speed": "10ms",
