...
# Mount routers
from app.api import admin, auth, billing, brokers, broker_cron, copy_trading, dashboard, market_data, reports, strategies, subscriptions, trades, user, watchlist, websocket  # noqa: E402
